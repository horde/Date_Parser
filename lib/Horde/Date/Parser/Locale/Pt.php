    ...
    public function initDefinitions()
    {
        ...
        $this->definitions = [
            'time' => [
                ...
                new Horde_Date_Parser_Handler([':separator_at?', ':repeater_time', ':repeater_day_portion?'], null),
                new Horde_Date_Parser_Handler([':separator_at?', ':time', ':repeater_time'], null),			// ás 10 horas
                /*
...
*/
            ...
            'date' => [
                ...
                new Horde_Date_Parser_Handler([':scalar_day', ':separator_at?', ':repeater_month_name', ':separator_at?', ':scalar_year', ':separator_at?', 'time?'], 'handle_sd_rmn_sy'),
                /*
